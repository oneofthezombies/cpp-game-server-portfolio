...
// auto BattleEventLoopLinux::AddClientFd(const FileDescriptorLinux::Raw
// client_fd,
...
//         TinyJson{}.Set("matched_client_fds",
//         matched_client_fds).ToString()}};
//   }
...
//             .Set("errc",
//             std::make_error_code(client_fd_0_res.Err()).message())
//             .ToString()}};
//   }
...
//             .Set("errc",
//             std::make_error_code(client_fd_1_res.Err()).message())
//             .ToString()}};
//   }
